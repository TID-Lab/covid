    ...
    <h1> Designed by </h1>
      <div className='CreditImages'>
        ...
        <a href='https://www.projectpeach.org/' target='_blank' rel='noopener noreferrer'>
          <img style={{height: '5rem', marginTop: '-1rem'}} src='/images/projectpeachtext.png' alt='Project Peach Logo'></img>
        </a>
        <a href='http://tid.gatech.edu/' target='_blank' rel='noopener noreferrer'>
          <img style={{height: '4rem',  marginTop: '-.2rem'}} src='/images/tidlogo.png' alt='Technology  Logo'></img>
        </a>
      </div>
    </div>
  )

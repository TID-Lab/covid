...
routes.get('/twitter', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const { url } = req.query;
    try {
...
routes.get('/facebook', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const { url } = req.query;
    try {
        const response = yield axios({
            method: 'GET',
...
routes.get('/instagram', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const { url } = req.query;
    try {
        const response = yield axios({
            method: 'GET',
...
routes.post('/twitter/tweet', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const response = yield oauth.post('https://api.twitter.com/1.1/statuses/update.json', oauth_access_token, oauth_access_token_secret, req.body);

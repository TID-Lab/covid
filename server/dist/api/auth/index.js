...
const oauth = require('../../util/oauth-promise')(process.env.CALLBACK_URL ||
 ...
 */
routes.post('/login', (req, res) => __awaiter(this, void 0, void 0, function* () {
 ...
 */
routes.post('/logout', (req, res) => __awaiter(this, void 0, void 0, function* () {
 ...
 */
routes.get('/check', (req, res) => __awaiter(this, void 0, void 0, function* () {
...
// OAuth Step 1
routes.post('/twitter/oauth/request_token', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const { oauth_token, oauth_token_secret } = yield oauth.getOAuthRequestToken();
...
routes.post('/twitter/oauth/access_token', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const { oauth_access_token, oauth_access_token_secret } = yield oauth.getOAuthAccessToken(oauth_token, oauth_token_secret, oauth_verifier);
...
routes.post('/twitter/logout', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {

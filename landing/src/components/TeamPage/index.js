...
const TeamPage = (props) => {
  return (<div className='TeamPage'> 
      <div className='Leadership'>
          ...
          <TeamMember imgLink='/images/pinar_keskinocak.jpg' alt='Pinar' name='Pinar Keskinocak' desc='Pinar Keskinocak is the William W. George Chair and Professor in the H. Milton Stewart School of Industrial and Systems Engineering at Georgia Tech. She is also co-founder and director of the Center for Health and Humanitarian Systems. ' websiteUrl='https://chhs.gatech.edu/'> </TeamMember>
          <TeamMember imgLink='/images/andrea_grimes_parker.png' alt='Andrea' name='Andrea Grimes Parker' desc='Andrea Grimes Parker is an Associate Professor in the School of Interactive Computing at Georgia Tech. She is also an Adjunct Associate Professor in the Rollins School of Public Health at Emory University. ' websiteUrl='https://www.cc.gatech.edu/~andrea/'> </TeamMember>
      ...
      <div className='TeamMemberSection'>
        ...
        <div className='TeamMembers'> 
          ...
          <TeamMember imgLink='/images/akane_fujimoto.png' alt='Akane' name='Akane Fujimoto' desc='3rd year PhD student in Industrial Engineering at Georgia Tech working with Dr. Pinar Keskinocak. She is interested in applying optimization and statistics to medical decision making, healthcare operations, and humanitarian logistics. ' websiteUrl='https://akanefujimoto.com/'> </TeamMember>
